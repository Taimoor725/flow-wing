    ...
    <Card className="w-full max-w-[95vw] lg:w-[95vw] xl:max-w-full xl:h-[55vh] lg:h-[52vh] flex lg:flex-row flex-col border border-[#5EDD4D]/30 rounded-[20px] lg:rounded-[40px] bg-white overflow-hidden relative shadow-2xl">
      ...
      <CardHeader className="lg:w-1/2 w-full flex flex-col justify-center items-start gap-4 lg:px-2 xl:px-4 sm:px-6 md:px-8 lg:pl-16 xl:pl-20 _lg:pr-10">
        ...
        <div className="text-sm sm:text-base xl:text-xl lg:text-base font-light text-[#0B2404B2] leading-relaxed">
          An Optimistic L2 with Ethereum security and Avail’s blazing-fast data layer — Colichain delivers speed without compromise. No tradeoffs — just faster, cheaper, and fully scalable transactions with real-time performance monitoring.
        </div>
        <div className="w-full h-[2px] bg-[#1111111A] my-3 lg:my-1"></div>

        <div className="flex gap-5 _flex-wrap justify-center">
          <div className="flex flex-col items-center">
            <div className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-5xl">6X</div>
            <div className="text-xs sm:text-sm md:text-base lg:text-base xl:text-xl text-[#0B2404B2] font-medium">Faster</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-5xl">10X</div>
            <div className="text-xs sm:text-sm md:text-base lg:text-base xl:text-xl text-[#0B2404B2] font-medium">Cheaper to Operate</div>
          </div>
        </div>
      </CardHeader>
