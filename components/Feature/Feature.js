...
function Feature() {
    return (
        <div className='w-screen h-auto bg-[#0B2404]'>
            <ButtonUI />
            <CardSection />
        </div>
    )
...
const ButtonUI = () => {
    return (
        <div className="w-screen h-auto justify-center items-center flex flex-col gap-12">
            <Button className='mt-40 flex justify-center items-center bg-white px-6 py-7 shadow-2xl border-[1px] border-gray-300 rounded-[40px] hover:cursor-pointer'>
                <Image src="/icons/bolt.svg" alt='service-button' width={100} height={100} className='w-12 h-12 object-cover' />
                <div className='text-2xl font-extralight text-[#0B2404]'>Explore Features</div>
            </Button>

            {/* testimonials  */}
            <div className='flex flex-col w-[70%] justify-center items-center gap-10'>
                <div className=' text-8xl font-extrabold text-white flex justify-center items-center'>
                    {/* What We Build */}
                    What Sets Us Apart
                </div>
                <div className=' text-center text-2xl font-extralight text-white/70 w-[65%]'>
...
const CardSection = () => {
    return (
        <div className="w-screen h-auto px-32 flex justify-center mt-20 pb-32">
            <div className="w-[79%] grid grid-cols-3 gap-12">
