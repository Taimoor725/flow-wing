...
function Avatars() {
    return (
            ...
            <div className=" lg:w-[42rem] w-[37rem] h-[4rem] flex lg:flex-row flex-col -translate-x-[10rem]">
                ...
                <div className='h-full relative w-1/2 items-center lg:hidden block'>
                    <Image
                        ...
                        height={60}
                        alt='avtars'
                        className="lg:min-w-16 lg:min-h-16 w-10 h-10 rounded-full object-cover  absolute left-64 top-0 z-[10] border-gray-400 border-1"
                    />
                    <Image
                        src="/avtar/3.jpg"
                        width={60}
                        height={60}
                        alt='avtars'
                        className=" lg:min-w-16 lg:min-h-16 w-10 h-10 rounded-full top-0 object-cover absolute left-72 z-[20] border-gray-400 border-1"
                    />
                    <Image
                        src="/avtar/1.jpg"
                        width={60}
                        height={60}
                        alt='avtars'
                        className=" lg:min-w-16 lg:min-h-16 w-10 h-10 rounded-full object-cover top-0 absolute left-80 z-[30] border-gray-400 border-1"
                    />
                </div>

                <div className='lg:text-xl text-base  font-extralight text-[#F9FFFACC] w-full  flex items-center lg:justify-end justify-center lg:translate-x-0 translate-x-4 '>
